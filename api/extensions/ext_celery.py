...
def init_app(app: DifyApp) -> Celery:
    ...
    imports = [
        ...
        "schedule.clean_temporary_upload_files_task",
    ]
    ...
    beat_schedule = {
        ...
        # everyday 01:00
        "clean_temporary_upload_files_task": {
            "task": "schedule.clean_temporary_upload_files_task.clean_temporary_upload_files_task",
